...
class TP2b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_win, 0, 0, 1, 2)
        for r in range(0, 1):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/fran/Documents/UCA/4to año/Radiodifusión/git/Radiodifusion/TP1/Parte 3/FM.dat', True, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.analog_quadrature_demod_cf_0_0, 0))
    ...
    def set_Vc(self, Vc):
        self.Vc = Vc
        self.blocks_multiply_const_vxx_0.set_k(1/self.Vc)
